...
def fix_ids():
    ...
    i = 0
    for cds_f in os.listdir('data/FungiDB/cds'):
        cds_records = list()
        cds_path = os.path.join('data/FungiDB/cds', cds_f)
    ...
    i = 0
    for prot_f in os.listdir('data/FungiDB/proteomes'):
        prot_records = list()
        prot_path = os.path.join('data/FungiDB/proteomes', prot_f)
